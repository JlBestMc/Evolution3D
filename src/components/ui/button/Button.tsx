...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary:
      "bg-gradient-to-r from-blue-950 to-purple-950 text-white/20 hover:from-transparent hover:to-transparent hover:border-purple-900 border-purple-900 border",
    secondary:
