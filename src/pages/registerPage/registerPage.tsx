      ...
      <div className="flex-1 flex items-center justify-center">
        <form
          onSubmit={async (e) => {
            ...
            setError(null);
            setInfo(null);
            const { error, needsConfirm } = await signUpWithPassword(
              email,
              password,
              name || undefined
            );
            if (error) {
              ...
              setInfo(
                "We sent you a confirmation email. Please verify your account to continue."
              );
            } else {
          ...
          <div className="relative py-3 sm:max-w-xl sm:mx-auto">
            <div className="relative px-4 py-10 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
              <div className="max-w-md mx-auto">
                ...
                {info && (
                  <p className="text-green-600 mb-4 text-center text-sm">{info}</p>
                )}
                <div className="mt-5">
                  <label
